      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900 dark:text-slate-300 poppins">
        <section className="min-h-screen">
          <nav className="py-6 mb-16 flex justify-between items-center">
            <h1 className="text-3xl font-extrabold fraunces bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 bg-clip-text text-transparent hover:from-teal-500 hover:via-cyan-500 hover:to-blue-500 transition-all duration-300 drop-shadow-lg tracking-tight">
              cahyo<span className="text-teal-600 dark:text-teal-400">DEV</span>
            </h1>
          ...
          <div className="text-center p-10">
            ...
            <p className="text-lg py-6 leading-8 text-gray-600 md:text-xl max-w-2xl mx-auto dark:text-slate-300">
              Hai! 👋 Aku Fullstack Developer yang suka banget bikin website dan
              aplikasi keren. Dari design sampai jadi, aku siap bantu ide kamu
              jadi nyata!
              <span className="block mt-2 font-semibold text-teal-600 dark:text-teal-400">
                Yuk kita collab dan bikin project yang asik bareng! 🚀
              </span>
            </p>
          </div>
        ...
        <section className="py-20 bg-gradient-to-b from-transparent to-gray-50 dark:to-gray-800/30">
          <div className="text-center mb-16">
            ...
            <p className="text-lg leading-8 text-gray-600 dark:text-slate-300 max-w-3xl mx-auto mb-4">
              Sejak awal perjalanan saya sebagai freelance developer, saya telah
              bekerja remote untuk beberapa{" "}
            ...
            <p className="text-lg leading-8 text-gray-600 dark:text-slate-300 max-w-3xl mx-auto">
              Saya menawarkan berbagai macam layanan, termasuk programming dan
              design.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="group bg-white dark:bg-gray-800 text-center shadow-xl p-8 rounded-3xl border-2 border-transparent hover:border-pink-200 dark:hover:border-pink-800 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <h4 className="text-teal-600 dark:text-teal-400 font-bold mb-6 text-lg">
                Tools Desain
              </h4>
            ...
            <div className="group bg-white dark:bg-gray-800 text-center shadow-xl p-8 rounded-3xl border-2 border-transparent hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              ...
              <div className="grid grid-cols-4 gap-4">
                <div className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-110">
                  <span className="text-3xl mb-2 text-orange-500">
                    <AiOutlineHtml5 />
                  </span>
                ...
                <div className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-110">
                  <span className="text-3xl mb-2 text-blue-500">
                    <FaCss3 />
                  </span>
                  <p className="text-xs text-gray-700 dark:text-slate-300 font-medium">
                    CSS
                ...
                <div className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-110">
                  <span className="text-3xl mb-2 text-yellow-500">
                    <IoLogoJavascript />
                  </span>
                  <p className="text-xs text-gray-700 dark:text-slate-300 font-medium">
                    JS
                ...
                <div className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-110">
                  <span className="text-3xl mb-2 text-cyan-500">
                    <RiTailwindCssFill />
                  </span>
                  <p className="text-xs text-gray-700 dark:text-slate-300 font-medium">
                    Tailwind
                ...
                <div className="flex flex-col items-center p-3 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-all duration-300 hover:scale-110">
                  <span className="text-3xl mb-2 text-purple-500">
                    <FaPhp />
                  </span>
                  <p className="text-xs text-gray-700 dark:text-slate-300 font-medium">
                    PHP
        ...
        <section className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
          <div className="text-center mb-20">
            <div className="inline-block mb-4">
              <span className="bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg">
                💼 My Works
              </span>
            </div>
            ...
            <p className="text-xl leading-8 text-gray-600 dark:text-slate-300 max-w-4xl mx-auto">
              ...
              , saya memberikan solusi digital yang inovatif, terstruktur dan
              efisien. Portofolio ini menunjukkan dedikasi saya dalam mengubah
              konsep menjadi implementasi yang robust.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-green-300 dark:hover:border-green-700">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors duration-300">
                  E-commerce Simple
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Platform toko online sederhana dengan fitur shopping cart dan
                  katalog produk
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-green-100 to-green-200 dark:from-green-900/50 dark:to-green-800/50 text-green-800 dark:text-green-200 text-xs rounded-full font-semibold shadow-sm">
                    React
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-teal-100 to-teal-200 dark:from-teal-900/50 dark:to-teal-800/50 text-teal-800 dark:text-teal-200 text-xs rounded-full font-semibold shadow-sm">
                    Tailwind
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-cyan-100 to-cyan-200 dark:from-cyan-900/50 dark:to-cyan-800/50 text-cyan-800 dark:text-cyan-200 text-xs rounded-full font-semibold shadow-sm">
                    Node.js
                  </span>
                </div>
              </div>
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-blue-300 dark:hover:border-blue-700">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300">
                  Daily Task Manager
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Aplikasi manajemen tugas harian dengan fitur reminder dan
                  tracking progress
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-blue-100 to-blue-200 dark:from-blue-900/50 dark:to-blue-800/50 text-blue-800 dark:text-blue-200 text-xs rounded-full font-semibold shadow-sm">
                    React
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-indigo-100 to-indigo-200 dark:from-indigo-900/50 dark:to-indigo-800/50 text-indigo-800 dark:text-indigo-200 text-xs rounded-full font-semibold shadow-sm">
                    Redux
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-900/50 dark:to-purple-800/50 text-purple-800 dark:text-purple-200 text-xs rounded-full font-semibold shadow-sm">
                    MongoDB
                  </span>
                </div>
              </div>
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-orange-300 dark:hover:border-orange-700">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors duration-300">
                  Food Delivery Website
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Platform food delivery dengan online ordering dan real-time
                  tracking pengiriman
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-orange-100 to-orange-200 dark:from-orange-900/50 dark:to-orange-800/50 text-orange-800 dark:text-orange-200 text-xs rounded-full font-semibold shadow-sm">
                    Next.js
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-red-100 to-red-200 dark:from-red-900/50 dark:to-red-800/50 text-red-800 dark:text-red-200 text-xs rounded-full font-semibold shadow-sm">
                    Tailwind
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-yellow-100 to-yellow-200 dark:from-yellow-900/50 dark:to-yellow-800/50 text-yellow-800 dark:text-yellow-200 text-xs rounded-full font-semibold shadow-sm">
                    PostgreSQL
                  </span>
                </div>
              </div>
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-violet-300 dark:hover:border-violet-700">
              <div className="absolute top-4 right-4 z-10">
                <span className="bg-violet-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg">
                  Entertainment
                </span>
              </div>
              <div className="relative overflow-hidden">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                  Anime Streaming Platform
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Platform streaming anime dengan koleksi lengkap, watchlist,
                  dan episode tracking
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-violet-100 to-violet-200 dark:from-violet-900/50 dark:to-violet-800/50 text-violet-800 dark:text-violet-200 text-xs rounded-full font-semibold shadow-sm">
                    React
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-purple-100 to-purple-200 dark:from-purple-900/50 dark:to-purple-800/50 text-purple-800 dark:text-purple-200 text-xs rounded-full font-semibold shadow-sm">
                    Video.js
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-fuchsia-100 to-fuchsia-200 dark:from-fuchsia-900/50 dark:to-fuchsia-800/50 text-fuchsia-800 dark:text-fuchsia-200 text-xs rounded-full font-semibold shadow-sm">
                    MongoDB
                  </span>
                </div>
              </div>
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-cyan-300 dark:hover:border-cyan-700">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors duration-300">
                  Prompt Library Manager
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Platform untuk menyimpan, mengorganisir, dan berbagi AI
                  prompts dengan komunitas
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-cyan-100 to-cyan-200 dark:from-cyan-900/50 dark:to-cyan-800/50 text-cyan-800 dark:text-cyan-200 text-xs rounded-full font-semibold shadow-sm">
                    Next.js
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-emerald-300 dark:hover:border-emerald-700">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">
                  Point of Sale System
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Sistem POS lengkap dengan inventory management, sales
                  reporting, dan payment integration
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-emerald-100 to-emerald-200 dark:from-emerald-900/50 dark:to-emerald-800/50 text-emerald-800 dark:text-emerald-200 text-xs rounded-full font-semibold shadow-sm">
                    Laravel
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-green-100 to-green-200 dark:from-green-900/50 dark:to-green-800/50 text-green-800 dark:text-green-200 text-xs rounded-full font-semibold shadow-sm">
                    Vue.js
            ...
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 border-2 border-transparent hover:border-amber-300 dark:hover:border-amber-700">
              ...
              <div className="p-6">
                <h5 className="text-xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors duration-300">
                  Mining Management System
                </h5>
                <p className="text-gray-600 dark:text-slate-300 mb-4 line-clamp-2">
                  Sistem manajemen pertambangan dengan monitoring operasional,
                  safety tracking, dan production analytics
                </p>
                <div className="flex flex-wrap gap-2">
                  <span className="px-3 py-1.5 bg-gradient-to-r from-amber-100 to-amber-200 dark:from-amber-900/50 dark:to-amber-800/50 text-amber-800 dark:text-amber-200 text-xs rounded-full font-semibold shadow-sm">
                    React
                  </span>
                  <span className="px-3 py-1.5 bg-gradient-to-r from-yellow-100 to-yellow-200 dark:from-yellow-900/50 dark:to-yellow-800/50 text-yellow-800 dark:text-yellow-200 text-xs rounded-full font-semibold shadow-sm">
                    Node.js
